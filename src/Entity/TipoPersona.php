...
class TipoPersona
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Tercero", mappedBy="tipoPersonaRel")
     */
    protected $tercerosTipoPersonaRel;
     ...
     * @return mixed
     */
    public function getTercerosTipoPersonaRel()
    {
        return $this->tercerosTipoPersonaRel;
    }

    /**
     * @param mixed $tercerosTipoPersonaRel
     */
    public function setTercerosTipoPersonaRel($tercerosTipoPersonaRel): void
    {
        $this->tercerosTipoPersonaRel = $tercerosTipoPersonaRel;
    }
