...
class Salida extends \FPDF
{
    ...
    Generar($em, $codigoMovimiento)
    {
        ...
        $this->Body($pdf);
        $pdf->Output("Salida de almacen{$arMovimiento->getNumero()}_{$arMovimiento->getTerceroRel()->getNombreCorto()}.pdf", 'D');
    }
