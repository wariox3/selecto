...
{
    /**
     * @Route("/general/administracion/Tercero/lista", name="tercero_lista")
     */
    ...
    /**
     * @Route("/general/administracion/Tercero/nuevo/{id}", name="tercero_nuevo")
     */
    ...
    /**
     * @Route("/administracion/administracion/Tercero/detalle/{id}", name="tercero_detalle")
     */
