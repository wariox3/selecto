...
{
    /**
     * @Route("/InformeMovimiento/lista", name="informe_movimiento_lista")
     */
    public function lista(Request $request)
    {
        ...
        $form = $this->createFormBuilder()
            ...
            ->add('txtNumeroMovimiento', TextType::class, array('required' => false, 'data' => $session->get('filtroMovimientoNumero')))
