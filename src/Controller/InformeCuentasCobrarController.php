...
class InformeCuentasCobrarController extends Controller
{
    ...
    public function informe(Request $request)
    {
        ...
        $form = $this->createFormBuilder()
            ...
            ->add('txtCuentaCobrar', IntegerType::class, array('required' => false, 'data' => $session->get('filtroInformeCuentasCobrarCodigo')))
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            if ($form->get('btnFiltrar')->isClicked()) {
                ...
                $session->set('filtroInformeCuentasCobrarCodigo', $form->get('txtCuentaCobrar')->getData());

            }
        }
        $arCuentasCobrar = $paginator->paginate($em->getRepository(CarCuentaCobrar::class)->informe(), $request->query->getInt('page', 1), 50);
        return $this->render('Informe/InformeCuentasCobrar.html.twig', [
